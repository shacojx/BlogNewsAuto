<%-- 
    Document   : NewInfo
    Created on : Aug 5, 2020, 1:46:29 PM
    Author     : Admin
--%>
...
<html lang="en">
    <head>
        ...
        <title>Tin Tức An Ninh Mạng</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="section-row sticky-container">
                            <div class="row">
                                ...
                                <div class="row">
                                    <img class="img-responsive" src="${Ne.cover}">  
                                </div>
                            <div class="main-post">
                                ${Ne.content}
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="aside-widget">
                            ...
                            <c:forEach items="${Listtop4}" var="i">
                                <div class="post post-widget">
                                    <a class="post-img" href="${pageContext.request.contextPath}/NewDetail?id=${i.id}"><img src="${i.cover}" alt="" style="height: 100px;"></a>
                                    <div class="post-body">
