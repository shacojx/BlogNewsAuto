    ...
    <body>
        ...
        <div class="section">
            ...
            <div class="container">
                ...
                <!-- row -->
                <div class="row">
                    <c:forEach items="${listtop6}" var="i" begin="0" end="3">
                        <!-- post -->
                        <div class="col-md-3">
                            <div class="post">
                                <a class="post-img" href="${pageContext.request.contextPath}/NewDetail?id=${i.id}"><img class="img-responsive" src="${i.cover}" alt="" style="height: 150px;"></a>
                                <div class="post-body">
                                    <div class="post-meta">
                                    ...
                                    <h5 class="post-title" style="font-size: 13px; word-break: break-all;"><a href="${pageContext.request.contextPath}/NewDetail?id=${i.id}"><c:out value = "${i.title}"/></a></h5>
                ...
                <!-- row -->
                <div class="row">
                    <c:forEach items="${listtop6}" var="i" begin="4" end="7">
                        <!-- post -->
                        <div class="col-md-3">
                            <div class="post">
                                <a class="post-img" href="${pageContext.request.contextPath}/NewDetail?id=${i.id}"><img class="img-responsive" src="${i.cover}" alt="" style="height: 150px;"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="aside-widget">
                            ...
                            <c:forEach items="${listNew}" var="i" begin="0" end="2">
                                <!-- post -->
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="post">
        ...
        <c:if test = "${end < 2}">
            <div class="container" style="margin-left: 20%">                  
                <ul class="pagination">
                    <li class="page-item"><a href="${pageContext.request.contextPath}/News?index=1">Start: 1</a></li>
                        <c:forEach begin="1" end="${end}" var="i">
                        <li class="${i==index?"active":""}" class="page-item"><a class="${i==index?"active":""}" href="${pageContext.request.contextPath}/News?index=${i}"><c:out value = "${i}"/></a></li>
                        </c:forEach>
                    <li class="page-item"><a href="${pageContext.request.contextPath}/News?index=${end}">End: <c:out value = "${end}"/></a></li>
                </ul>
            </div>
        </c:if>
        <c:if test = "${index ==1}">
            <div class="container" style="margin-left: 20%">                  
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/News?index=${index+1}"> >> </a></li>
                    <li class="page-item"><a href="${pageContext.request.contextPath}/News?index=${end}">End: <c:out value = "${end}"/></a></li>
                </ul>
            </div>
        </c:if>
