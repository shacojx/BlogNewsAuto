    ...
    <body>
        ...
        <c:if test = "${end < 2}">
            <div class="container" style="margin-left: 20%">                  
                <ul class="pagination">
                    <li class="page-item"><a href="${pageContext.request.contextPath}/TvNews?index=1">Start: 1</a></li>
                        <c:forEach begin="1" end="${end}" var="i">
                        <li class="${i==index?"active":""}" class="page-item"><a class="${i==index?"active":""}" href="${pageContext.request.contextPath}/TvNews?index=${i}"><c:out value = "${i}"/></a></li>
                        </c:forEach>
                    <li class="page-item"><a href="${pageContext.request.contextPath}/TvNews?index=${end}">End: <c:out value = "${end}"/></a></li>
                </ul>
            </div>
        </c:if>
        <c:if test = "${index ==1}">
            <div class="container" style="margin-left: 20%">                  
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/TvNews?index=${index+1}"> >> </a></li>
                    <li class="page-item"><a href="${pageContext.request.contextPath}/TvNews?index=${end}">End: <c:out value = "${end}"/></a></li>
                </ul>
            </div>
        </c:if>
