...
<html>
    <head>
        <%
            GetNuoc getnc = new GetNuoc();
            ArrayList<String> list_nc = getnc.list_quocgia();
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="wrapper">
            ...
            <c:set var = "admin5" scope = "request" value = "active"/>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6 connectedSortable">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-chart-pie mr-1"></i> Sơ Đồ Phân Tích Quốc Gia</h3>
                                    </div>
                            ...
                            <div class="col-md-6 connectedSortable">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-chart-pie mr-1"></i> Top 5 Quốc Gia Xem Nhiều Nhất</h3>
                                    </div>
