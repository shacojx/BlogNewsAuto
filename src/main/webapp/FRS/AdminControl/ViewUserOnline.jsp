...
<%@page import="Controller.Blog.SessionCounter"%>
...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="wrapper">
            ...
            <c:set var = "admin6" scope = "request" value = "active"/>
                            ...
                            <div class="col-12">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">Thống Kê Người Dùng Đang Online</h3>
