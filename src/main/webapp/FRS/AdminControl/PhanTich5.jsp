                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link" href="${pageContext.request.contextPath}/FRS/AdminControl/PhanTich2.jsp">Ngày</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/FRS/AdminControl/PhanTich5.jsp">Custom Time</a>
                            </li>
                        </ul>
                        <br>
                        <div>
                            <form action="${pageContext.request.contextPath}/PhanTichTime" method="post">
                                <div class="row">
                                    <label for="team" class="col-2">
                                        Từ Ngày:
                                    </label>
                                    <div class="col-2">
                                        <input name="tuday" type="datetime-local" class="form-control" id="exampleInputFile">
                                    </div>
                                    <div class="col-2"></div>
                                    <label for="team" class="col-2">
                                        Đến Ngày:
                                    ...
                                    <div class="col-2">
                                        <input name="denday" type="datetime-local" class="form-control" id="exampleInputFile">
                                    </div>
                                    <div class="col-2">
                            ...
                            <div class="col-12">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">Thống Kê Lượt Xem Từ Ngày ${day1} Đến Ngày ${day2}</h3>
