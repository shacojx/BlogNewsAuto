                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/FRS/AdminControl/PhanTich3.jsp">Tháng</a>
                            </li>
                        ...
                        <br>
                        <div>
                            <form action="${pageContext.request.contextPath}/PhanTichThang" method="post">
                                <div class="row">
                                    <label for="team" class="col-2">
                                        Tháng:
                                    </label>
                                    <div class="col-6">
                                        <input name="day" type="month" class="form-control" id="exampleInputFile">
                                    </div>
                                    <div class="col-4">
                            ...
                            <div class="col-12">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">Thống Kê Lượt Xem Tháng ${dayday}</h3>
