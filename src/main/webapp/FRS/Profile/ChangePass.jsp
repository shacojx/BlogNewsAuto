...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <c:set var = "monitor1" scope = "request" value = "menu-open"/>
        <c:set var = "monitor2" scope = "request" value = "active"/>
        <c:set var = "addip" scope = "request" value = "active"/>
        <div class="wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <form role="form" action="${pageContext.request.contextPath}/ChangPassWord" method="post">
                                        <div class="card-body">

                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Mật Khẩu Cũ</label>
                                                <input name="oldpass" type="password" class="form-control" id="exampleInputFile">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Mật Khẩu Mới</label>
                                                <input name="newpass" type="password" class="form-control" id="exampleInputFile">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Nhập Lại Mật Khẩu Mới</label>
                                                <input name="renewpass" type="password" class="form-control" id="exampleInputFile">
                                            </div>
