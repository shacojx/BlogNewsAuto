...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        %>
        <c:set var = "upnews" scope = "request" value = "active"/>
        <div class="wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <form role="form" action="${pageContext.request.contextPath}/UpCover" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                    ...
                                    <!-- form start -->
                                    <form role="form" action="${pageContext.request.contextPath}/UpNews" method="post">
                                        <div class="card-body">

                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Tiêu Đề</label>
                                                <input name="title" type="text" class="form-control" id="exampleInputFile">
                                            </div>
