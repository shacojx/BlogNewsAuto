    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (location.contains("null") == false) {
                Visiter vis = new Visiter(userIpAddress, location, startDate, id_news, "Video Games");
                vidao.insert(vis);
            }
            ...
            if (check == false) {
                ...
                if (index > endPage) {
                    ...
                    request.setAttribute("fuck", "VideoGames");
                    request.getRequestDispatcher("/MovieNews/VideoGames.jsp").forward(request, response);
                }
            }
